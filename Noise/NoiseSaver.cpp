...
enum saveMode {
    MODE_NONE, MODE_PREVIEW, MODE_NORMAL
};
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    if (command == 'c' || command == 'C') {
        ...
        Window w = Window((TCHAR *) _T("test"), hInstance, WndProc, nCmdShow, width, height, parent, true);
        ...
        Window w = Window((TCHAR *) _T("test"), hInstance, WndProc, nCmdShow, width, height, NULL, false);
        windowHandle = w.getHwnd();
